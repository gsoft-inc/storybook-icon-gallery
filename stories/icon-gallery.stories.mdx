...
<Preview>
    <Story name="get copy value">
        <IconGallery getCopyValue={({ itemName, variantSize }) => `${itemName.toUpperCase()}-${variantSize}`}>
            <IconGallery.Variants name="add">
                <IconGallery.Variant size={24}>
                    <AddIcon24 />
                </IconGallery.Variant>
...
<Preview>
    <Story name="get display name">
        <IconGallery getDisplayName={({ itemName }) => itemName.toUpperCase()}>
            <IconGallery.Variants name="add">
                <IconGallery.Variant size={24}>
                    <AddIcon24 />
                </IconGallery.Variant>
...
When autosize is disabled, it's your responsability to set the `width` and `height` of the icons.

<Preview>
    <Story name="autosize">
        <IconGallery>
            <IconGallery.Variants name="add" autosize={false}>
                <IconGallery.Variant size={24}>
