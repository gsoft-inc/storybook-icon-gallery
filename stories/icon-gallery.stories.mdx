...
<Props
    components={{
        ...
        "IconGallery.Icon": IconGallery.Icon
    }}
/>
...
When autosize is disabled, you are responsible of settings the `width` and `height` of the variant icons.

<Preview>
    <Story name="autosize">
        <IconGallery>
            <IconGallery.Item name="add">
                <IconGallery.Variant size={24} autosize={false}>
                    <AddIcon24 style={{ width: "24px", height: "24px" }} />
                </IconGallery.Variant>
                <IconGallery.Variant size={32} autosize={false}>
                    <AddIcon style={{ width: "32px", height: "32px" }} />
                </IconGallery.Variant>
                <IconGallery.Variant size={48} autosize={false}>
